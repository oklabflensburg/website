...
Compare land-use types across Schleswig-Holstein municipalities.
...
The [project source](https://codefor.de/projekte/fl-open-surface-map/) describes the initiative. The status shown here is an editorial snapshot; current tasks and technical guidance live in the linked repository.
